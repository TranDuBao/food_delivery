...
class _NewPasswordViewState extends State<NewPasswordView> {
  ...
  void btnSubmit() {
    ...
    serviceCallForgotSetNew({
      "resetToken": widget.nObj[KKey.resetToken]?.toString() ?? widget.nObj[KKey.resetCode]?.toString() ?? "",
  ...
  void serviceCallForgotSetNew(Map<String, dynamic> parameter) {
    ...
    ServiceCall.post(parameter, SVKey.svForgotPasswordSetNew, withSuccess: (responseObj) async {
      Globs.hideHUD();
      if ((responseObj[KKey.message] as String? ?? "").isNotEmpty || responseObj.isNotEmpty) {
